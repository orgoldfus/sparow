...
pub use contracts::{
    ...
    BackgroundJobStatus, CancelJobResult, CancelQueryExecutionResult, ConnectionDetails,
    ConnectionDraft, ConnectionSessionStatus, ConnectionSummary, ConnectionTestResult,
